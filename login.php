...
<body>
    ...
    <?php if (isset($error)): ?>
        <p style="color: red; font-style: italic;">username/password salah ngab!</p>
    <?php endif; ?>
    ...
    <div id="card">
        <div id="card-content">
            ...
            <form method="post" class="form" action="">
                <label for="username" style="padding-top:13px">&nbsp
                Username</label>
                <input class="form-content" type="text" name="username" id="username" autocomplete="on" required />
